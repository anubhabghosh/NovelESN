...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun 16 19:24:08 2020
...
descrip = "program that predicts a time series of scalars at certain instants"\
" of time specified by the user."

parser = argparse.ArgumentParser(description=descrip)
parser.add_argument("training_file", type=str, help="path to a txt file with a"
" single column representing the training time series y_0, y_1, ...y_M-1.") 
...
parser.add_argument("test_data", type=str, default=None, help="Path to a txt"
